...
public class Exercicio1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bem vindos novos programadores!");
		
		//Declarar variaveis:
		
		int valor1 = 100; // variavel inteira
		float valor2 = 10.5f; // variavel do tipo real (float)
		double valor3 = 10.5; // variavel do tipo real (double)
		String nome = "Daniel"; // variavel com dados literais
		boolean valor4 = false; // false ou true
		boolean valor5 = true;
